...
<body id="body" class="theme--dark">
    ...
    <div id="container">
      ...
      <section class="left-section">
        <img class="profile-pic" src="{{ asset(arrayhaskeythenreturnitsvalue($field_data,'dc-image')) }}" />

        <div class="profile-detail">
          <span class="profile-maps">
            <i class="material-icons"></i>
           {{ arrayhaskeythenreturnitsvalue($field_data,'ds-address') }}
          </span>
          <p class="profile-name">{{arrayhaskeythenreturnitsvalue( $field_data,'dc-name')}}</p>
          <span class="profile-summary">{{arrayhaskeythenreturnitsvalue( $field_data,'dc-desg')}}</span>
          <a download="MyPdf" class="profile-cv" href="{{ asset(arrayhaskeythenreturnitsvalue($field_data,'dc-resume')) }}">Download CV</a>

        </div>

        <div class="profile-pils">
          <span class="pils"><a href="{{arrayhaskeythenreturnitsvalue( $field_data,'dc-twitter')}}" target="_blank"><i class="fa fa-twitter"></i> Twitter</a></span>
