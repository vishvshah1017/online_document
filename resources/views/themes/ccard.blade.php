...
.info-grid {
  ...
  box-shadow: 0px 2px 15px rgba(255, 255, 255, 0.432);
  border-radius: 6px;
...
<body>
    <div class="front-side">
      ...
      <div class="info-grid">
        <div class="name">
          <h2> <p>{{arrayhaskeythenreturnitsvalue( $field_data,'cc-name')}}</p></h2>
          <h5> <p>{{arrayhaskeythenreturnitsvalue( $field_data,'cc-business')}}</p></h5>
        </div>
        <div class="addr">
          ...
          <p>{{arrayhaskeythenreturnitsvalue( $field_data,'cc-address') }}
        ...
        <div class="phoneNo">
          ...
          <div>
            <a class="anchortag" href="tel:{{arrayhaskeythenreturnitsvalue($field_data,'cc-phone')}}">
                <p>{{arrayhaskeythenreturnitsvalue($field_data,'cc-phone')}}</p>
          </div>
        ...
        <div class="emailId">
          ...
          <p class="email"><a class="anchortag" href="mailto:{{ arrayhaskeythenreturnitsvalue($field_data,'cc-email') }}">
            {{ arrayhaskeythenreturnitsvalue($field_data,'cc-email') }}</a>
          </p>
          <p class="web">
            <a class="anchortag"  href="{{ arrayhaskeythenreturnitsvalue($field_data,'cc-website') }}">
                {{ arrayhaskeythenreturnitsvalue($field_data,'cc-website') }}
                </a>
          </p>
        </div>
      </div>
    ...
    <div class="back-side">
      ...
      <div class="name-tag">
        <h1>
             <p>{{arrayhaskeythenreturnitsvalue( $field_data,'cc-name')}}</p>
        </h1>
        <h3><p>{{arrayhaskeythenreturnitsvalue( $field_data,'cc-business')}}</p></h3>
      </div>
    </div>
