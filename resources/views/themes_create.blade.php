        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('themes_store') }}"  enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="themes_name" id="themes_name" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="themes_desc" class="form-label">Themes Desc</label>
                            <input type="text" class="form-control" name="themes_desc" id="themes_desc" aria-describedby="t">

                          </div>
                          <div class="mb-3">
                            <label for="themes_link" class="form-label">Themes Link</label>
                            <input type="text" class="form-control" name="themes_link" id="themes_link" aria-describedby="t">
